                    ...
                    <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                        <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#"
                            ...
                            <img class="avatar img-thumbnail rounded-circle shadow"
                                src="{{ asset('admin/img/profile_av.png') }}" alt="">
                        </a>
                        <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                            <div class="card border-0">
                                <div class="card-body border-bottom d-flex">
                                    <img class="avatar rounded-circle"
                                        src="https://ui-avatars.com/api/?name={{ Auth::guard('admins')->user()->email }}"
                                        alt="">
                                    <div class="flex-fill ms-3">
                                        <h6 class="card-title mb-0">{{ Auth::guard('admins')->user()->name }}
                                        </h6>
